                ...
                <div class="col-lg-7">
                    ...
                    <div class="row gx-3">
                        <div class="boxpd1" onclick="location.href='#';" style="cursor: pointer;">
                            {{-- <span class="judulp1">{{ limitWord($item->jawaban, 13) }} ...</span> --}}
                            <span class="judulp1">Judul</span>
                            <span class="tanggalp1">Tanggal</span>
                    ...
                    <br>
                    <a href="kirimPertanyaanPC"><input class="btn btn-primary" type="submit" value="Kirim Pertanyaan"></a>
