            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/tambahdata" class="d-flex align-items-center">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting_asc" tabindex="0" aria-controls="add-row"
                                                        ...
                                                        style="width: 195.125px;">Name</th>
                                                    <th class="sorting" tabindex="0" aria-controls="add-row"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                                        style="width: 285.391px;">Position</th>
                                                    <th class="sorting" tabindex="0" aria-controls="add-row"
                                                        rowspan="1" colspan="1"
                                                        aria-label="Office: activate to sort column ascending"
                                                        style="width: 152.141px;">Office</th>
                                                    <th style="width: 122.344px;" class="sorting" tabindex="0"
