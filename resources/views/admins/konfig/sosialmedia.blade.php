                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            <h4 class="card-title">Daftar Sosial Media</h4>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group form-group-default">
                                                    <label for="exampleFormControlFile1">Unggah Icon</label>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="add-row"
                                                        ...
                                                        style="width: 500px;">Sosial Media</th>
                                                        <th class="sorting_asc" tabindex="0" aria-controls="add-row"
                                                        rowspan="1" colspan="1" aria-sort="ascending"
                                                        aria-label="Name: activate to sort column descending"
                                                        style="width: 15px;">Hyperlink</th>
