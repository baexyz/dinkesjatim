            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/tambahuser" class="d-flex align-items-center">
                                        ...
                                        <table id="multi-filter-select"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th style="width: 20px;"><select class="form-select border-0"
                                                    ...
                                                    <th style="width: 25px;"><select class="form-select border-0"
                                                            aria-label="Default select example">
