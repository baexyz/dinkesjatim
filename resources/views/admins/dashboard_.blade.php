          ...
          <nav class="navbar header-navbar pcoded-header">
              <div class="navbar-wrapper">
                  <div class="navbar-logo">
                      ...
                      <a href="/dashboard">
                          <img class="img-fluid" src="assets/images/admin_dinkes/logo.png" alt="Theme-Logo" />
                      </a>
                          ...
                          <ul class="pcoded-item pcoded-left-item">
                              ...
                              <li>
                                <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Tujuan</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Kebijakan</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Struktur Organisasi</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Profil Pejabat</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="bs-basic-table.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Call Center Covid-19</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                          </ul>

                          <div class="pcoded-navigation-label" data-i18n="nav.category.forms">Data &amp; Informasi</div>
                          <ul class="pcoded-item pcoded-left-item">
                              <li>
                                  <a href="/agenda" class="waves-effect waves-dark">
                                      <span class="pcoded-micon"><i class="ti-agenda"></i><b>FC</b></span>
                                      <span class="pcoded-mtext" data-i18n="nav.form-components.main">Agenda</span>
                                      <span class="pcoded-mcaret"></span>
                                  </a>
                              </li>
                              <li>
                              ...
                              <li>
                                <a href="map-google.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Public Corner</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="map-google.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Dokumen & Publikasi</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="map-google.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Peraturan & Aturan</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                              <li>
                                <a href="map-google.html" class="waves-effect waves-dark">
                                    ...
                                    <span class="pcoded-mtext" data-i18n="nav.form-components.main">Laporan Kinerja</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                              </li>
                          </ul>
                              ...
                              <div class="row align-items-center">
                                  <div class="col-md-8">
                                      <div class="page-header-title">
                                          ...
                                          <p class="m-b-0">Welcome to Admin Website Dinas Kesehatan</p>
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                            ...
                                            <div class="col-xl-3 col-md-6">
                                                <div class="card">
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Total Berita</h6>
                                                            </div>
                                                    ...
                                                    <div class="card-footer bg-c-purple">
                                                        <div class="row align-items-center">
                                                            <div class="col-9">
                                                                <p class="text-white m-b-0">Saat ini</p>
                                                            </div>
                                                            <div class="col-3 text-right">
                                                                <i class="fa fa-hand-pointer-o text-white f-16"></i>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Total Artikel</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Total Pertanyaan</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
                                                                <i class="fa fa-comments-o f-28"></i>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-block">
                                                        <div class="row align-items-center">
                                                            <div class="col-8">
                                                                ...
                                                                <h6 class="text-muted m-b-0">Total File</h6>
                                                            </div>
                                                            <div class="col-4 text-right">
