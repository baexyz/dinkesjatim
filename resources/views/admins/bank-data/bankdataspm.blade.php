...
@section('page-header')
    <div class="page-inner">
        <div class="page-header">
            <h4 class="page-title">Bank Data (SPM)</h4>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <a href="/tambahfilespm" class="d-flex align-items-center">
                            <h4 class="card-title">Bank Data (SPM)</h4>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="multi-filter-select"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th>No.</th>
                                                    <th style="width: 20px;"><select class="form-select border-0" aria-label="Default select example">
                                                    ...
                                                    <th class="sorting_asc" tabindex="0"
                                                        ...
                                                        style="width: 195px;">Nama SPM File</th>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="multi-filter-select" rowspan="1" colspan="1"
                                                        aria-label="Position: activate to sort column ascending"
                                                        style="width:0px;">Tahun</th>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="multi-filter-select" rowspan="1" colspan="1"
                                                        aria-label="Age: activate to sort column ascending"
                                                        style="width: 0px;">Tribulan</th>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="multi-filter-select" rowspan="1" colspan="1"
                                                        aria-label="Start date: activate to sort column ascending"
                                                        style="width: 0px;">Data Ditambahkan</th>
                                                    <th class="sorting" tabindex="0"
                                                        aria-controls="multi-filter-select" rowspan="1" colspan="1"
