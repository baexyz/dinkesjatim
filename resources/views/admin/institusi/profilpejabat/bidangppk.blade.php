                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            @else
                                <div class="col-md-6 col-lg-12">
                                    <a href="/profilpejabat/tambahbidangppk" class="btn btn-primary">Tambah Profil Pejabat Bidang Pencegahan dan Pengendalian Penyakit</a>
                                    ...
                                    <form action="/profilpejabat/updatebidangppk" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <label for="detail_jabatan">Detail Jabatan</label>
