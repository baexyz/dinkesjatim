            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Halaman Maklumat</div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            @if (empty($institusi_maklumat[0]))
                            <div class="col-md-6 col-lg-12">
                                <form action="/institusi/maklumat/halamanMaklumat" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <input id="profil_id" name="profil_id" type="text" value="{{ $profil[6]->id }}"
                                            hidden>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <form action="/institusi/updatekebijakan" method="POST"
                                    enctype="multipart/form-data">
                                    {{-- @method('put') --}}
                                    @csrf
                                    @foreach ($institusi_maklumat as $item)
                                        <div class="form-group">
                                            <label for="judul">Judul</label>
                                            <input class="form-control" type="text" placeholder="Judul" name="judul"
