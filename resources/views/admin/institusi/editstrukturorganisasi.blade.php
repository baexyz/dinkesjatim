        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @if (empty($institusi_struktur_organisasi[0]))
                            <div class="col-md-6 col-lg-12">
                                <form action="/institusi/strukturorganisasi/halamanStrukturOrganisasi" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <input id="profil_id" name="profil_id" type="text" value="{{ $profil[4]->id }}"
                                            hidden>
                            ...
                            <div class="col-md-6 col-lg-12">
                                <form action="/institusi/updatestrukturorganisasi" method="POST"
                                    enctype="multipart/form-data">
                                    {{-- @method('put') --}}
                                    @csrf
                                    @foreach ($institusi_struktur_organisasi as $item)
                                        <div class="form-group">
                                            <label for="judul">Judul</label>
                                            <input class="form-control" type="text" placeholder="Judul" name="judul"
