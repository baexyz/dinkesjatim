        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            @if (empty($institusi_visimisi[0]))
                                <div class="col-md-6 col-lg-12">
                                    <form action="/institusi/visimisi/createvisimisi" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-group">
                                            <input id="profil_id" name="profil_id" type="text"
                                                value="{{ $profil[0]->id }}" hidden>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control form-control-sm" name="bidang_id" id="bidang_id">
                                                @foreach ($bidang as $b)
                            ...
                            @else
                                <div class="col-md-6 col-lg-12">
                                    <form action="/institusi/updatevisimisi" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        @foreach ($institusi_visimisi as $item)
                                            <div class="form-group">
                                                <input id="profil_id" name="profil_id" type="text"
                                                    value="{{ $profil[0]->id }}" hidden>
                                                <label for="judul">Judul</label>
