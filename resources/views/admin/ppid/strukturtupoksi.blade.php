                        ...
                        <div class="row">
                            @if (empty($stpk[0]))
                                <div class="col-md-6 col-lg-12">
                                    <form action="/ppid/createstpk" method="POST"
                                        enctype="multipart/form-data">
                                        @csrf

                                        <div class="form-group">
                                            <input type="text" name="kategori" id="kategori" value="struktur tupoksi" hidden>
                            ...
                            @else
                                <div class="col-md-6 col-lg-12">
                                    <a href="/ppid/tambahstpk" class="btn btn-primary">Tambah Data Struktur Tupoksi</a>
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach ($stpk as $item)
                                                    <tr>
                                                        <td>{{ $loop->iteration }}</td>
                                                        <td>{{ $item->judul }}</td>
                                                        <td>
                                                            <a href="/ppid/stpk/{{ $item->id }}/edit" class="btn btn-primary">Edit</a>
                                                            <form action="/ppid/stpk/{{ $item->id }}/hapus" method="POST" class="d-inline">
                                                            @csrf
