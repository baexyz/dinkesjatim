...
@section('container')
    <div class="row g-5" style="column-gap: 5.9rem">
        ...
        @if($institusi_struktur_organisasi->count() > 0)
            ...
            <div class="position-relative h-150">
                <img class="w-100 h-200 mb-4 rounded wow zoomIn" data-wow-delay="0.9s"
                    src="/storage/post-images/{{ $institusi_struktur_organisasi[0]->image }}" style="object-fit: cover;">
            </div>
            <div>
                {!! $institusi_struktur_organisasi[0]->body !!}
            </div>
        @endif
        </div>
